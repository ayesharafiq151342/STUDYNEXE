    ...
    <div className="bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-black font-bold text-3xl md:text-4xl mt-2">
          Study in <span className="text-purple-700 "> the UK?</span> 
        </h2> <hr className="border-t-2 border-purple-700 mt-2 w-1/4 mx-auto"/>
        <p className="text-gray-700 text-base mt-6 leading-relaxed">
          International students may find various excellent educational opportunities in the United Kingdom. For the 2019/2020 school year, the United Kingdom welcomed roughly 37,000 Pakistani students, as the Higher Education Statistics Agency reported. There are many benefits of studying in the UK from Pakistan. Students who study in the UK from Pakistan have several opportunities open to them, including access to top-tier educational institutions, exceptional faculty, and state-of-the-art research facilities.
        </p>
        <p className="text-gray-700 text-base mt-4 leading-relaxed">
          Undergraduate, master's, and doctoral degrees are offered across various disciplines at UK universities. Average annual tuition for a British bachelor's degree may range from £13,000 to £26,000, with postgraduate degrees costing from £16,000 to £35,000. In the United Kingdom, the cost of living varies significantly from region to region, with London having one of the highest averages. A student's average cost of living is between £12,000 and £15,000.
        </p>
        <p className="text-gray-700 text-base mt-4 leading-relaxed">
          MR Consultants is an excellent resource for Pakistani students interested in learning more about the costs of studying in the UK. If you need help figuring out how to pay for your education in the United Kingdom, our team of seasoned advisors is here to help.
        </p>
        <p className="text-gray-700 text-base mt-4 leading-relaxed">
          From deciding on a suitable school and program to laying the groundwork for a study visa in the UK from Pakistan, our expert advisors are here to help you every step of the way. Are you ready to begin your study abroad adventure in the United Kingdom? Contact us immediately and let MR Consultants assist you with every step of your study in the UK from Pakistan.
        </p>
      </div>
      <div className="max-w-4xl mx-auto text-center mt-20">
        <h2 className="text-black font-bold text-2xl md:text-3xl">
          Why Choose <span className="text-purple-700 ">UK?</span> 
        </h2>
